...
-- Date: 2026-02-26 16:24:52.417917
...
CREATE TABLE `Names` (
  ...
  `name_full` varchar(127) DEFAULT NULL,
  PRIMARY KEY (`name_id`)
...
CREATE TABLE `Places` (
  ...
  `place_row` varchar(7) DEFAULT NULL,
  `place_axis` varchar(7) DEFAULT NULL,
  `place_mark` varchar(7) DEFAULT NULL,
...
CREATE TABLE `Sensors` (
  ...
  `sensor_name` int(11) NOT NULL,
  `sensor_type` int(11) NOT NULL,
  `sensor_place` int(11) NOT NULL,
  `sensor_status` int(11) NOT NULL DEFAULT 1,
  `sensor_units` int(11) NOT NULL,
...
CREATE TABLE `Statuses` (
  ...
  `status_full` varchar(255) DEFAULT NULL,
...
CREATE PROCEDURE `SearchByName`(
    IN p_pattern VARCHAR(100) CHARACTER SET utf8mb4
)
BEGIN
    
    SET @p = REPLACE(p_pattern, '*', '%') COLLATE utf8mb4_unicode_ci;
    ...
    WHERE n.name_full LIKE @p COLLATE utf8mb4_unicode_ci;
END //
DELIMITER ;
